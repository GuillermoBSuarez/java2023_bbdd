...
public class JMenuEmpleados extends JFrame {
	...
	public JMenuEmpleados() {
		...
		JMenuItem itemBuscarDepartamento = new JMenuItem("Buscar por departamento");
		itemBuscarDepartamento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new JBuscarPorDepartamento();
			}
		});
		menuAcciones.add(itemBuscarDepartamento);
